...
const TERMS_BODY = `
These Global Terms and Conditions (this “Agreement”) constitute a legally binding agreement between each User (“you” or “your”) and The Great American Labor Company (“Great American Labor”) governing use of Great American Labor’s website and platform, more particularly described in Section 1 below (collectively referred to herein as the “Platform”).
...
SECTION 16 CONTAINS AN ARBITRATION AGREEMENT. THIS ARBITRATION AGREEMENT, WITH LIMITED EXCEPTION, REQUIRES YOU TO SUBMIT DISPUTES AND CLAIMS YOU HAVE AGAINST GREAT AMERICAN LABOR TO BINDING AND FINAL ARBITRATION ON AN INDIVIDUAL BASIS. PLEASE READ IT CAREFULLY AS IT AFFECTS YOUR LEGAL RIGHTS.
...
2. THE GREAT AMERICAN LABOR COMPANY’S ROLE. Great American Labor is not an employment agency service or business, and Great American Labor is not an employer of any User. Users are not employees, partners, representatives, agents, joint venturers, independent contractors or franchisees of Great American Labor. Users hereby acknowledge and agree that (a) Great American Labor does not (i) perform Jobs nor employ individuals to perform Jobs, (ii) supervise, scope, direct, control or monitor Laborers’ work (including that Great American Labor does not set Laborers’ work locations, work hours, or terms of work), nor provide tools or supplies to, or pay any expenses of, Laborers, or (iii) have any control over the quality, timing, legality, failure to provide, or any other aspect whatsoever of Jobs or Users (or the acts or omissions thereof), nor of the integrity, responsibility, competence, qualifications, communications, or the ratings or reviews provided by Users with respect to each other. Users do not have authority to, and may not act as agent for, nor bind or make any representations on behalf of, Great American Labor (including that Laborers may not modify all or any part of the Platform fees.

Great American Labor is neither responsible nor liable for workers’ compensation or any tax payment or withholding, including applicable sales taxes, HST/QST/GST/PST, unemployment or employment insurance, Canada Pension Plan, disability insurance, applicable VAT, National Insurance, employer’s liability, employer training tax, social security contributions, PAYE or other applicable payroll withholdings in connection with a User’s use of the Platform, or personal income tax. The Laborer assumes full and sole responsibility for all required and applicable income tax and social contributions such as Social Security or National Insurance Contribution withholdings as to the Laborer and all persons engaged by the Laborer in the performance of the Job. Each User assumes all liability for proper classification of such User’s workers based on applicable legal guidelines.
...
will not use the Platform for the purchase, sale or delivery of alcohol or any controlled or illegal substances or services; and
...
will respond to invitations promptly; provide timely, high-quality services for your Clients; only offer and provide Jobs for which you have the necessary expertise to perform; and perform the Jobs as agreed upon with your Client in a safe manner; and
...
7. DEACTIVATION AND SUSPENSION. In the event of an actual or suspected breach by you of any part of this Agreement, or if your conduct poses a risk to Great American Labor or the Platform (including abuse, fraud or interference with the proper working of the Platform), Great American Labor may (a) suspend your right to use the Platform pending its investigation; and/or (b) deactivate your account or limit your use of the Platform, until the issue is resolved to Great American Labor’s reasonable satisfaction. Great American Labor will provide you with written notice of its determination to deactivate or suspend your account and the basis for such deactivation or suspension. If you wish to appeal any determination made by Great American Labor pursuant to this Section, please contact us here within 14 days of receipt of such notice with the grounds for your appeal. If Great American Labor suspends or deactivates your account or limits your use of the Platform pursuant to this Section, you may not register and/or create a new account under different usernames, identities or contact details (whether under your or any other name or business name), even if you are acting on behalf of a third party. Even after your right to use the Platform is suspended, terminated or limited, this Agreement will remain enforceable against you.
...
WITHOUT LIMITING THE FOREGOING, GREAT AMERICAN LABOR AND ITS PARENTS, AFFILIATES, LICENSORS, AND THEIR RESPECTIVE DIRECTORS, OFFICERS, SHAREHOLDERS, AGENTS, INVESTORS, SUBSIDIARIES, ATTORNEYS, REPRESENTATIVES, INSURERS, EMPLOYEES, SUCCESSORS AND ASSIGNS (COLLECTIVELY, “AFFILIATES”, AND TOGETHER WITH GREAT AMERICAN LABOR, THE “GREAT AMERICAN LABOR PARTIES”):
...
(c) DO NOT WARRANT, ENDORSE, GUARANTEE, RECOMMEND, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY ANY THIRD PARTY THROUGH THE PLATFORM OR ANY HYPERLINKED WEBSITE OR SERVICE, INCLUDING BY ANY LABORER, AND THE GREAT AMERICAN LABOR PARTIES WILL NOT BE A PARTY TO, OR IN ANY WAY MONITOR, ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.
...
IF, NOTWITHSTANDING THE FOREGOING EXCLUSIONS, IT IS DETERMINED THAT THE GREAT AMERICAN LABORPARTIES OR THEIR CORPORATE PARTNERS ARE LIABLE FOR DAMAGES, IN NO EVENT WILL THE AGGREGATE LIABILITY, WHETHER ARISING IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EXCEED: (A) IF YOU ARE A CLIENT, THE TOTAL FEES PAID BY YOU TO GREAT AMERICAN LABOR IN THE SIX (6) MONTHS PRIOR TO THE TIME SUCH CLAIM AROSE; AND (B) IF YOU ARE A LABORER, THE TOTAL JOB PAYMENTS PAID TO YOU BY CLIENTS IN THE SIX (6) MONTHS PRIOR TO THE TIME SUCH CLAIM AROSE, TO THE EXTENT PERMITTED BY APPLICABLE LAW.


13. INDEMNIFICATION. Users’ indemnification obligations are set out below in this Section. Great American Labor reserves the right, in its own sole discretion, to assume the exclusive defense and control of any matter otherwise subject to your indemnification. You will not, in any event, settle any claim or matter without the prior written consent of Great American Labor.

(a) Client Indemnification. If you are a Client, you shall indemnify, defend, and hold harmless the Great American Labor Parties from and against any and all Liabilities incurred in connection with (i) your use of, inability to use, or participation on, the Platform; (ii) your breach or violation of this Agreement; (iii) your violation of any law, or the rights of any User or third party; (iv) your use of any third-party links or websites that appear on the Platform; (v) the acts or omissions of any Client Agents; and (vi) the consequences of any Laborer’s performance or failure to perform a Job.

(b) Laborer Indemnification. If you are a Laborer, you shall indemnify, defend, and hold harmless the Great American Labor Parties from and against any and all Liabilities incurred in connection with (i) your use of, inability to use, or participation on, the Platform; (ii) your participation in Jobs, or your ability or inability to perform Jobs or to receive payment therefor; (iii) your breach or violation of this Agreement; (iv) your violation of any law, or the rights of any User or third party; (v) the acts or omissions of any Laborer Assistants; and (vi) the consequences of any Client’s performance or failure to perform their obligations under this Agreement.


14. CHANGES TO THIS AGREEMENT AND THE PLATFORM.

(a) Changes to this Agreement. Great American Labor reserves the right, in its sole and absolute discretion, at any time, to review, change, modify, update, add to, supplement, suspend, discontinue, or delete any term(s) or provision(s) of this Agreement. Notice of such amendments may be given by posting such updates or modifications (or notice thereof) on the Platform, by e-mail or in any other reasonable manner; and the amendments will be effective upon such posting. Your continued use of the Platform after such posting constitutes your consent to be bound by this Agreement, as amended.
...
To the extent permitted by law, Great American Labor shall not be liable to you for any modification to all or any portion of this Agreement.

(b) Changes to the Platform. Great American Labor reserves the right to, at any time, review, improve, modify, update, upgrade, discontinue, impose limits, or restrict access to, whether temporarily or permanently, all or any portion of the Platform (including any content or information available on or through the Platform), without any liability to Great American Labor. To the extent permitted by law, Great American Labor shall not be liable to you for any updates, upgrades, modifications to or discontinuance of all or any portion of the Platform.


15. DISPUTE RESOLUTION. To expedite resolution and reduce the cost of any dispute, controversy or claim related to, arising from or regarding your use of the Platform, your relationship with Great American Labor, Jobs, or this Agreement (including previous versions), (“Dispute”), you can try to find an amicable solution with Great American Labor before initiating any out of court settlement (such as mediation or arbitration) or court proceeding. Such informal negotiations will commence upon written notice. Great American Labor’s address for providing such notice is rob@greatamericanlabor.com.


16. ARBITRATION AGREEMENT.

PLEASE READ THIS SECTION CAREFULLY — IT AFFECTS YOUR LEGAL RIGHTS AND GOVERNS HOW YOU AND GREAT AMERICAN LABOR CAN BRING CLAIMS COVERED BY THIS ARBITRATION AGREEMENT (“ARBITRATION AGREEMENT”). THIS SECTION WILL, WITH LIMITED EXCEPTION, REQUIRE YOU AND GREAT AMERICAN LABORTO SUBMIT CLAIMS TO BINDING AND FINAL ARBITRATION ON AN INDIVIDUAL BASIS.
...
(a) Agreement to Binding Arbitration. IN EXCHANGE FOR THE BENEFITS OF THE SPEEDY, ECONICAL, AND IMPARTIAL DISPUTE RESOLUTION PROCEDURE OF ARBITRATION, YOU AND GREAT AMERICAN LABORMUTUALLY AGREE TO WAIVE YOUR RESPECTIVE RIGHTS TO RESOLUTION OF ALL DISPUTES OR CLAIMS COVERED BY THIS ARBITRATION AGREEMENT IN A COURT OF LAW BY A JUDGE OR JURY AND AGREE TO RESOLVE ANY DISPUTES BY BINDING ARBITRATION ON AN INDIVIDUAL BASIS AS SET FORTH HEREIN.

This Arbitration Agreement shall survive the termination of this Agreement and your relationship with Great American Labor. To the fullest extent permitted by applicable law, you and Great American Labor agree to arbitrate any and all disputes and claims (“Claim(s)”) relating to, arising from or regarding your use of the Platform, your relationship with Great American Labor, Jobs, or this Agreement (including previous versions), including Claims by Great American Labor, Claims against Great American Labor and Claims against Great American Labor’s Affiliates (including its parent company).

To the fullest extent permitted by applicable law, this includes Claims related to payments, any city, county, state or federal wage and hour law, compensation, meal or rest breaks, expense reimbursement, wrongful termination, discrimination, harassment, retaliation, fraud, defamation, trade secrets, unfair competition, personal injury, property damage or loss, emotional distress, any promotions or offers made by Great American Labor, or the threatened or actual suspension or deactivation of your account; breach of any express or implied contract or breach of any express or implied covenant; claims arising under federal or state consumer protection laws; claims arising under antitrust laws; claims arising under the Telephone Consumer Protection Act and Fair Credit Reporting Act; claims arising under the Fair Labor Standards Act, Title VII of the Civil Rights Act of 1964, Uniform Trade Secrets Act, Defend Trade Secrets Act, Americans With Disabilities Act, Age Discrimination in Employment Act, Older Workers Benefit Protection Act, Family Medical Leave Act, Employee Retirement Income Security Act (except for individual claims for employee benefits under any benefit plan sponsored by Great American Labor and covered by the Employee Retirement Income Security Act or funded by insurance), and state or local statutes, if any, addressing the same or similar subject matters; and all other federal, state or local statutory and common law claims.

YOU ACKNOWLEDGE AND UNDERSTAND THAT YOU AND GREAT AMERICAN LABOR ARE WAIVING THE RIGHT TO SUE IN COURT OR HAVE A JURY TRIAL FOR ALL DISPUTES AND CLAIMS, UNLESS EXPRESSLY EXCLUDED IN THIS ARBITRATION AGREEMENT. THIS ARBITRATION AGREEMENT IS INTENDED TO REQUIRE ARBITRATION OF EVERY CLAIM OR DISPUTE THAT CAN LAWFULLY BE ARBITRATED, EXCEPT THOSE CLAIMS AND DISPUTES THAT, BY THE TERMS OF THIS ARBITRATION AGREEMENT, ARE EXPRESSLY EXCLUDED FROM THE REQUIREMENT TO ARBITRATE.

(b) Prohibition of Class Actions and Non-Individualized Relief. Except as otherwise required under applicable law, you and Great American Labor agree that any arbitration will be limited to the Claim between Great American Labor (and/or, if applicable, its Affiliates) and you individually. YOU ACKNOWLEDGE AND AGREE THAT YOU AND GREAT AMERICAN LABOR ARE EACH WAIVING THE RIGHT TO PARTICIPATE AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS ACTION LAWSUIT, CLASS-WIDE ARBITRATION, OR ANY OTHER REPRESENTATIVE PROCEEDING (“Class Action Waiver”). Further, unless both you and Great American Labor otherwise agree, the arbitrator may not consolidate more than one person’s claims and may not otherwise preside over any form of any class or representative proceeding. The arbitrator shall have no authority to consider or resolve any Claim or issue any relief on any basis other than an individual basis.
...
17. NO THIRD-PARTY BENEFICIARIES. Except as expressly set out herein and/or is otherwise required by applicable laws, this Agreement is for the sole benefit of Great American Labor and Users, and their permitted successors and assigns. There are no other third-party beneficiaries under this Agreement. None of the terms of this Agreement are enforceable by any persons who are not a party to this Agreement; provided, however, that Great American Labor may enforce any such provisions on behalf of its Affiliates.


18. RELATIONSHIP OF THE PARTIES. No agency, partnership, joint venture, employer-employee or franchiser-franchisee relationship exists, is intended or created between you and Great American Labor by this Agreement or your use of the Platform. Users do not have authority to act as agent for, nor to bind or make any representations on behalf of, Great American Labor.


19. WAIVER. Great American Labor’s waiver of a breach of any provision of this Agreement shall not operate or be construed as a waiver of any subsequent breach.
...
22. I agree to receive account updates and notifications.
...
export default function TermsOfService() {
  return (
    <div className="bg-white">
      {/* Subtle “Apple x Uber” legal header */}
      <div className="border-b border-slate-200 bg-white">
        <Container className="py-10 sm:py-12">
          <div className="flex flex-col gap-3">
            ...
            <h1 className="font-bold tracking-tight text-slate-900 text-[clamp(1.9rem,3.2vw,3.2rem)]">
      ...
      <Container className="py-10 sm:py-12">
        <div className="rounded-3xl border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.06)] overflow-hidden">
